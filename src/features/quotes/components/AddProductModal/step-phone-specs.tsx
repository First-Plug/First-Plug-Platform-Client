...
interface StepPhoneSpecsProps {
  productData: Partial<QuoteProduct>;
  onDataChange: (updates: Partial<QuoteProduct>) => void;
}

export const StepPhoneSpecs: React.FC<StepPhoneSpecsProps> = ({
  productData,
  onDataChange,
}) => {
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <p className="w-full text-muted-foreground text-left">
        Select the phone specifications you need. You can select multiple options
        for each field.
      </p>
      ...
      <div className="flex flex-col gap-2 w-full">
        ...
        <textarea
          ...
          placeholder="Storage capacity, color, connectivity (5G, 4G), screen size, etc."
