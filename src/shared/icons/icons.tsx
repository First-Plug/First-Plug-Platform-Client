...
export const NotificationIcon = ({
  ...
  return (
    <div>
      {hasNotification && (
        <div className="absolute bg-red-600 m-0.5 rounded-full w-2 h-2"></div>
      )}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-6.75 4.5h-.75m-2.25-1.5H21M21 15h-.75m-1.5-1.5H21m-1.5 3H21m-1.5 1.5H21"
      />
    </svg>
  );
};
